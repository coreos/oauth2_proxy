...
func main() {
	...
	flagSet.Bool("unset-authorization-header", false, "unset the Unauthorized header. Useful for when the presence of this header isn't wanted after proxying")
	flagSet.Bool("pass-user-headers", true, "pass X-Forwarded-User and X-Forwarded-Email information to upstream")
	flagSet.String("basic-auth-password", "", "the password to set when passing the HTTP Basic Auth header")
	flagSet.Bool("pass-access-token", false, "pass OAuth access_token to upstream via X-Forwarded-Access-Token header")
	flagSet.Bool("pass-host-header", true, "pass the request Host Header to upstream")
	flagSet.Bool("pass-user-as-email-header", false, "set the X-Forwarded-Email header to the username being logged in")
